<?php 
    function send_email($email_recive,$name,$contents,$subject ){
        ...
        $mail->Username   = "d15cqcn02@gmail.com"; // Tên đăng nhập tài khoản Gmail auto.zentgroup@gmail.com
        $mail->Password   = "12345678aA@"; //Mật khẩu của gmail 1@3$5^7*
        $mail->SetFrom("d15cqcn02@gmail.com", "Thương mại điện tử"); // Thông tin người gửi
        $mail->AddReplyTo("d15cqcn02@gmail.com","Thương mại điện tử");// Ấn định email sẽ nhận khi người dùng reply lại.
